...
<body>
	...
	<div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 id="header" class="page-header">Welcome aboard 
                    
                </h1>
            </div>
            <div class="row">
                <div class="col-lg-11"> 
                <p>Many people come and go, some of them for pleasure, others for responsibilities such as work and studies...
                   But what do all this people have in common? Many of them don't know the place they are going to and even less
                   where they are going to stay. Isn't that scary? Pretty scary. 
